...
const ConfirmarReserva = () => {
  ...
  useEffect(() => {
    if (selectedData.length > 0) {
      ...
      fetch(
        `https://api.curso.spazioserver.online/lugares/${firstReservation.lugarId}`
      )
        .then((response) => response.json())
        .then((data) => {
          setSpaceData(data);
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            ...
            <p>
              <strong>Lugar:</strong> {spaceData ? spaceData.nombre : "-"}
            </p>
            <p>
              <strong>Fecha:</strong>{" "}
              {selectedData.length > 0 ? selectedData[0].fecha : "-"}
            </p>
          </Box>
          <Box
            sx={{
      ...
      >
        ...
        <DialogContent>
          <DialogContentText>
            ¡Tu reserva ha sido creada con éxito! A continuación, se muestran
            los detalles:
          </DialogContentText>
          <Box
            sx={{
